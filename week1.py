...
print("\n📝 TUGAS UNTUK KAMU:")
print("1. Tulis perintah print() untuk menampilkan nama kamu")
print("2. Tulis perintah print() untuk menampilkan hobi kamu")
print("3. Coba ubah nama kamu menjadi huruf besar semua")

print("\n💡 Tips: Gunakan tanda kutip untuk menulis teks")
print("   Contoh: print('NAMA KAMU')")
